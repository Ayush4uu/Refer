...
BOT_TOKEN = "7173219284:AAEO1-gTcQ1OV3lAdAn25H-tSUUX_zPna3o"
PAYMENT_CHANNEL = "@refer4pay" #add payment channel here including the '@' sign
OWNER_ID = 6058231937 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@refer4pay"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
